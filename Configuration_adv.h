 ...
 */
#define HOTEND_IDLE_TIMEOUT //Custom Elboby
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300 //Custom ElBoby
  ...
  #define BLTOUCH_LCD_VOLTAGE_MENU //Custom Elboby
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu  //Custom Elboby
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 //Custom Elboby
  ...
  #define LCD_SHOW_E_TOTAL //Custom Elboby
...
#define SET_PROGRESS_MANUALLY
  ...
  #define SET_REMAINING_TIME            // Add 'R' parameter to set remaining time, otherwise use Marlin's estimate //Custom Elboby
  #define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction //Custom Elboby
  #define M73_REPORT                    // Report M73 values to host //Custom Elboby
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R') //Custom Elboby
  #if ENABLED(SET_INTERACTION_TIME)
    #define SHOW_INTERACTION_TIME         // Display time until next user interaction ('C' = filament change)
  #endif
  #define PRINT_PROGRESS_SHOW_DECIMALS  // Show/report progress with decimal digits, not all UIs support this //Custom Elboby
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //Custom Elboby
  ...
  #define UTF_FILENAME_SUPPORT //Custom Elboby
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' //Custom Elboby
 ...
 */
  ...
  #define BOOT_MARLIN_LOGO_ANIMATED // Animated Marlin logo. Costs ~3260 (or ~940) bytes of flash. //Custom Elboby
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps //Custom Elboby
  #define BABYSTEP_MULTIPLICATOR_Z  0.04       // (steps or mm) Steps or millimeter distance for each Z babystep //Custom Elboby
  #define BABYSTEP_MULTIPLICATOR_XY 0.004       // (steps or mm) Steps or millimeter distance for each XY babystep //Custom Elboby
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //Custrom Elboby

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //Custom Elboby
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor //Custom Elboby
  #endif
#endif
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                 // Requires ~3226 bytes //Custom Elboby
...
#define BEZIER_CURVE_SUPPORT        // Requires ~2666 bytes //Custom Elboby
...
#define SERIAL_FLOAT_PRECISION 4 //Custom Elboby
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      450  // (mm) The length of filament for a complete unload. //Custom Elboby
 ...
 */
#define AUTO_REPORT_POSITION //Custom Elboby
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT //Custom Elboby
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations //Custom Elboby
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) //Custom Elboby
...
#define CUSTOM_MENU_MAIN //Custom Elboby
#if ENABLED(CUSTOM_MENU_MAIN)
  //#define CUSTOM_MENU_MAIN_TITLE "Custom Commands"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script //Custom Elboby
 ...
 */
#define HOST_ACTION_COMMANDS //Custom Elboby
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback //Custom Elboby
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM          // Add a menu item that tells the host to start //Custom Elboby
  #define HOST_SHUTDOWN_MENU_ITEM       // Add a menu item that tells the host to shut down //Custom Elboby
#endif
...
//
#define PINS_DEBUGGING //Custom Elboby
 ...
 */
#define SOFT_RESET_VIA_SERIAL         // 'KILL' and '^X' commands will soft-reset the controller //Custom Elboby
